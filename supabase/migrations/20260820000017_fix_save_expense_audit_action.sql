-- Migration 20260820000017: Fix audit_action compatibility for save_expense

-- 1. Ensure audit_logs.action column is compatible with text values while enforcing domain integrity
do $$ begin
...
-- 2. Replace save_expense with explicit audit action typing
...
begin
  ...
  v_action := case when v_existing.id is not null then 'update' else 'create' end;
