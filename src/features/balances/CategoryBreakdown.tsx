...
import { PieChart, ChevronDown, User, Users } from "lucide-react"
    ...
    <div className="rounded-2xl border border-hair bg-surface p-5 shadow-2xs">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 id="category-breakdown-heading" className="text-sm font-bold uppercase tracking-wider text-ink">
              Category Breakdown
            </h2>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="min-h-9 rounded-xl border border-hair bg-surface px-3 py-1 text-xs font-semibold text-ink outline-none focus:border-brand cursor-pointer"
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-xl border border-hair bg-surface text-ink-soft hover:bg-canvas active:scale-[0.98] transition-transform cursor-pointer"
            aria-label={isExpanded ? "Collapse breakdown" : "Expand breakdown"}
            aria-expanded={isExpanded}
            aria-controls="category-breakdown-content"
          >
            <ChevronDown
              size={16}
      ...
      {/* Category Expanded Details: CSS Grid Spring Expansion */}
      <div
        id="category-breakdown-content"
        role="region"
            ...
            {isGroup && groupSummary.totalTripMinor > 0 && (
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between text-[11px] text-ink-faint">
                  <span>Trip Total: <span className="font-mono font-bold text-ink tnum">{formatMinor(groupSummary.totalTripMinor, baseCurrency)}</span></span>
                ...
                {nonZeroGroupItems.map((c) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-brand font-mono tnum">
                        {c.percentage.toFixed(0)}%
                      </span>
                    </div>
                    <p className="mt-2 font-mono text-base font-bold text-ink tnum">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`rounded-full px-2 py-0.5 text-[10px] font-bold font-mono tnum ${
                            isCredit
